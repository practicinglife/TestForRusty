---
description: 'Process tracking mode for systematic task execution with phase-based workflow and progress logging'
tools: ['codebase', 'editFiles', 'createFiles', 'runCommands']
---

# Process Tracking Mode

A structured workflow mode for systematic task execution with phase-based progress tracking and logging.
